...
const double H3_bind_en = 0.008481, He4_bind_en = 0.0283, C12_bind_en = 0.09215,
             B_bind_en = 0.0762;
const double He3_bind_en = 0.0077, D2_bind_en = 0.00222, Fe_bind_en = 0.49226,
             Mn_bind_en = 0.4820764;
...
// genie_analysis code, e.g. PhiOpeningAngleEl = 6 --> Delta-phi for the
// electron is 12.
const double PhiOpeningAngleEl = 6;
const double PhiOpeningAngleProt = 22.5;
const double PhiOpeningAngle = 6.;

static const Float_t par_EcUVW[6][3] = {{60, 360, 400}, {55, 360, 400},
                                        {50, 363, 400}, {52, 365, 396},
                                        {60, 360, 398}, {50, 362, 398}};
