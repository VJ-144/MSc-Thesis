    ...
    for (int ind2 = 0; ind2 < N_3p; ind2++) {
      if (ind1 != ind2 && ind1 < ind2) {
        ...
        if (N_p1det[count][2] != 0 && N_pthree != 0) {
          ...
          Ecal_3pto2p[count][0] = V4el.E() + TMath::Sqrt(m_prot * m_prot + V3prot[ind1].Mag() * V3prot[ind1].Mag()) -
          ...
          Ecal_3pto2p[count][1] = V4el.E() + TMath::Sqrt(m_prot * m_prot + V3prot[ind2].Mag() * V3prot[ind2].Mag()) -
                                  m_prot + bind_en[target_name];
...
void Subtraction::prot2_pi2_rot_func(TVector3 V3_2prot_corr[2], TVector3 V3_2prot_uncorr[2], TVector3 V3_2pi[2],
  ...
  if (N_all != 0) {
    ...
    for (int z = 0; z < N_2prot; z++) {
      ...
      P_2p2pito2p1pi[0] =
          P_2p2pito2p1pi[0] + (N_2p_1pi[z] / N_all) * (-P_2p1pito2p0pi[0] - P_2p1pito1p1pi[0] + P_2p1pito1p0pi[0]);
      P_2p2pito2p1pi[1] =
          P_2p2pito2p1pi[1] + (N_2p_1pi[z] / N_all) * (-P_2p1pito2p0pi[1] - P_2p1pito1p1pi[1] + P_2p1pito1p0pi[1]);
...
void Subtraction::prot3_pi1_rot_func(TVector3 V3_3prot_corr[3], TVector3 V3_3prot_uncorr[3], TVector3 V3_pi, int q_pi,
  ...
  if (N_all != 0) {
    ...
    //----------------------------------3p 1pi ->3p 0pi->1p0pi   ----------------------------------------------
    prot3_rot_func(V3_3prot_uncorr, V3_3prot_corr, V4_el, E_cal_3pto2p, p_miss_perp_3pto2p, P_3pto2p, N_p1, Ecal_3p1pi,
