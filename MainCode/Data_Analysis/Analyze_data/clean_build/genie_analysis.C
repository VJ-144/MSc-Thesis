...
index 0, resc_val > 1) or no
  ...
  //TH3D* h3_Electron_Mom_Theta_Phi = new TH3D("h3_Electron_Mom_Theta_Phi",";P_{e'} [GeV/c];#theta_{e'} [deg];#phi_{e'}
...
"", 6000, 0., 6.); // gchamber: electron momentum breakdown for 1e1p sample
                  h1_InteractionBreakdown_Omega_NoQ4Weight_InSector_el_mom_ptcut[WhichInt][WhichSector]  = new
...
"", 6000, 0., 6.); // gchamber: electron momentum breakdown for 1e1p sample with ptcut (if turned on)
                  h1_InteractionBreakDown_Omega_NoQ4Weight_Insector_prot_mom[WhichInt][WhichSector]  = new
...
"", 6000, 0., 6.); // gchamber: proton momentum breakdown for every proton passing fiducial, other cuts (inclusive)
                  h1_InteractionBreakDown_Omega_NoQ4Weight_Insector_prot_mom_QE[WhichInt][WhichSector]  = new
...
"", 6000, 0., 6.); // gchamber: proton momentum breakdown into different channels for 1e1p sample
                  ...
                  h1_InteractionBreakDown_NoQ4Weight_InSector_isFSI_prot_mom_QE[WhichInt][WhichSector][0] = new
...
distribution
          ...
          TProf_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector[WhichSector]  = new
TProfile("TProf_Omega_FullyInclusive_NoQ4Weight_Theta_Slice_InSector_"+TString(std::to_string(WhichSector)),"",6000,0.,6.);

          TProf_Theta_FullyInclusive_NoQ4Weight_Theta_Slice_InSector[WhichSector]  = new
...
TH2F("h2_Electron_Theta_Momentum_SecondSector",";P_{e'} [GeV/c];#theta_{e'}",6000,0.,6,360,0,360); TH2F
*h2_Electron_Theta_Momentum_ThirdSector = new TH2F("h2_Electron_Theta_Momentum_ThirdSector",";P_{e'}
[GeV/c];#theta_{e'}",6000,0.,6,360,0,360); TH2F *h2_Electron_Theta_Momentum_FourthSector = new
TH2F("h2_Electron_Theta_Momentum_FourthSector",";P_{e'} [GeV/c];#theta_{e'}",6000,0.,6,360,0,360); TH2F
*h2_Electron_Theta_Momentum_FifthSector = new TH2F("h2_Electron_Theta_Momentum_FifthSector",";P_{e'}
[GeV/c];#theta_{e'}",6000,0.,6,360,0,360); TH2F *h2_Electron_Theta_Momentum_SixthSector = new
TH2F("h2_Electron_Theta_Momentum_SixthSector",";P_{e'} [GeV/c];#theta_{e'}",6000,0.,6,360,0,360);
