...
struct Fiducial {
  ...
  TF1 *leftside_lim1_ec, *leftside_lim2_ec, *leftside_lim3_ec, *leftside_lim4_ec, *leftside_lim5_ec, *leftside_lim6_ec,
      *rightside_lim1_ec, *rightside_lim2_ec, *rightside_lim3_ec, *rightside_lim4_ec, *rightside_lim5_ec,
      *rightside_lim6_ec;
  ...
  // sector 3 has 4 gaps, first argument is the # of gaps, second corresponds to upper and lower limits of gap, the last
  ...
  // sector 5 has 4 gaps, first argument is the # of gaps, second corresponds to upper and lower limits of gap, the last
  // one is the number of parameters
